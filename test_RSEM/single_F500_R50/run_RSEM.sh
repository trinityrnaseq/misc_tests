...
../../../trunk/util/RSEM_util/run_RSEM_align_n_estimate.pl --transcripts simul.transcriptome.cdnas --seqType fa --single simul.reads.fa --no_group_by_component -- --fragment-length-mean 500
